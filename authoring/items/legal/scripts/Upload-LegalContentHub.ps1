...
$fieldPlan = @(
  ...
  @{ DataItem = '/sitecore/content/legal/legal/Home/people/hammad-akhtar'; Field = 'Photo'; File = 'hammad-akhtar.png'; Use = 'PersonProfile + PersonRelated Photo' }
  @{ DataItem = '/sitecore/content/legal/legal/Home/people/desiree-fields'; Field = 'Photo'; File = 'desiree-fields.png'; Use = 'PersonProfile + PersonRelated Photo' }
