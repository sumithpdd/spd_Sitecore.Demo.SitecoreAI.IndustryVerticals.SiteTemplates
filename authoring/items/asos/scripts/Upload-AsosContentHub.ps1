<#
.SYNOPSIS
  Upload Asos images to Sitecore Content Hub and emit Image field XML.
...
$xmlPath = Join-Path $repoMaps 'Asos-image-xml.json'
$existingXml = @{}
...
Write-Host "Wrote $csvPath (does not overwrite Asos-sitecore-image-field-map.csv)"
