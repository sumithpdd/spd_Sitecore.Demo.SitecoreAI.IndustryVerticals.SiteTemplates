/** Brand page metadata for Sitecore serialization (mirrors lyvera-brand-pages.ts). */
export const LYVERA_BRAND_PAGE_ITEMS = [
  { slug: 'keith-prowse', name: 'keith-prowse', title: 'Keith Prowse - part of Lyvera Group' },
  { slug: 'gullivers-sports-travel', name: 'gullivers-sports-travel', title: 'Gullivers Sports Travel – part of Lyvera Group' },
  { slug: 'events-international', name: 'events-international', title: 'Events International – part of Lyvera Group' },
  { slug: 'lime-venue-portfolio', name: 'lime-venue-portfolio', title: 'Lime Venue Portfolio - part of Lyvera Group' },
  { slug: 'the-experience-golf', name: 'the-experience-golf', title: 'The Experience Golf - part of Lyvera Group' },
  { slug: 'the-iluka-collective', name: 'the-iluka-collective', title: 'The iLUKA Collective - part of Lyvera Group' },
...
export const LYVERA_BLOG_ARTICLE_ITEMS = [
  {
    ...
    fields: {
      ...
      Content: `<p>There was a time when luxury was defined by what you owned. Today, it is increasingly defined by what you experience.</p>
...
<p>Through premium hospitality brands such as Keith Prowse and Events International, Lyvera delivers unforgettable access to some of the world's most iconic occasions.</p>`,
      PublishedDate: '20260603T120000Z',
