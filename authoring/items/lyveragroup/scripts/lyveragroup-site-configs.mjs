...
export function buildSiteIds(siteCode) {
  ...
  return {
    ...
    partialSlotHeader: `${base}52-0001-4000-8000-000000000001`,
    partialSlotFooter: `${base}53-0001-4000-8000-000000000001`,
...
export function createLyveraCorporateConfig() {
  ...
  return {
    ...
    homeSections: [
      { uid: 'LYV-HOME-001', rendering: 'Banner', ds: 'heroBanner', variant: 'LyveraBanner/Default' },
      { uid: 'LYV-HOME-002', rendering: 'Promo', ds: 'promoIntro', variant: 'LyveraPromo/ImageRightColor' },
      { uid: 'LYV-HOME-003', rendering: 'OurBrands', ds: 'ourBrands', variant: 'LyveraOurBrands/Default' },
      { uid: 'LYV-HOME-004', rendering: 'MultiPromoImageSlider', ds: 'multiPromo', variant: 'LyveraMultiPromoImageSlider/Default' },
      { uid: 'LYV-HOME-005', rendering: 'Promo', ds: 'promoWhat', variant: 'LyveraPromo/ImageLeftColor' },
      { uid: 'LYV-HOME-006', rendering: 'Promo', ds: 'promoHow', variant: 'LyveraPromo/Default' },
      { uid: 'LYV-HOME-007', rendering: 'Banner', ds: 'bannerWhy', variant: 'LyveraBanner/BackgroundText', styles: 'lyvera-banner-tricolor' },
      { uid: 'LYV-HOME-008', rendering: 'Promo', ds: 'promoCeo', variant: 'LyveraPromo/StackedColor' },
    ],
  };
}
