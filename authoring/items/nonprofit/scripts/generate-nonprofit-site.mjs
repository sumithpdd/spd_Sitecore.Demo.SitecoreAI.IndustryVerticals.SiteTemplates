...
const pages = [
  ...
  { id: ID.P_Food, parent: ID.P_GetHelp, path: 'get-help/emergency-help-with-food', title: 'Emergency help with food', nav: 'Food', r: ID.AdviceArticle },
  ...
  { id: ID.P_Aisha, parent: ID.P_Stories, path: 'stories/aisha-rent-notice', title: 'The notice was not valid', nav: 'Aisha', r: ID.StoryDetail },
  { id: ID.P_Elaine, parent: ID.P_Stories, path: 'stories/elaine-warm-space', title: 'The library closed. The hub stayed open.', nav: 'Elaine', r: ID.StoryDetail },
