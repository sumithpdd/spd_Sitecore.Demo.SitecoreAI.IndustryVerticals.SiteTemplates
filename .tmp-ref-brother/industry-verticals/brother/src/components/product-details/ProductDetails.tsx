...
import { ProductDetailsSection } from '../non-sitecore/ProductDetailsSection';
...
export const Default = (props: ProductDetailsProps) => {
  ...
  return (
    <section className={`component article-listing py-6 ${styles}`} id={id}>
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="max-w-xl space-y-4 pb-4 lg:px-10">
            ...
            <button className="main-btn bg-blue-600 hover:bg-blue-700">
              <MapPin className="size-5" strokeWidth={3} />
              {t('find_retailer_btn_text') || 'Find a Retailer'}
            </button>
      ...
      {/* Product Details and Overview Section */}
      ...
      <div className="container mt-12">
        <h2 className="mb-6 text-3xl font-bold">
          {t('related_products_label') || 'Related Products'}
        </h2>
