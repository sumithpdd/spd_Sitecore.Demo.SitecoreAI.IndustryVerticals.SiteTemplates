...
const SESSION_ID_KEY = 'lyvera-cdp-session-id';
const SESSION_EVENTS_KEY = 'lyvera-cdp-session-events';
const VISIT_COUNT_KEY = 'lyvera-cdp-visit-count';
const VISIT_FLAG_KEY = 'lyvera-cdp-visit-recorded';
