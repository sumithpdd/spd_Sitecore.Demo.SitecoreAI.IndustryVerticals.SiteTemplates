...
export function DemoLoginModal(): JSX.Element | null {
  ...
  return (
    <div
      className="marley-login-modal fixed inset-0 z-[300] flex items-center justify-center bg-black/40 p-4"
      role="dialog"
      aria-modal="true"
      aria-labelledby="demo-login-title"
    >
      <div className="marley-login-modal__card w-full max-w-md rounded-sm bg-white p-8 shadow-xl md:p-10">
        <p className="mb-8 text-2xl font-bold tracking-tight text-[#c83232]">{siteLabel}</p>
