...
const THINKING_HITS: SearchHit[] = [
  ...
  },
  {
    ...
    summary:
      'Europe’s energy sovereignty now depends on cyber resilience. Named expert Elisabeth Plakinger.',
  ...
  },
  {
    ...
    summary:
      'Orchestrating flexibility in Europe’s power system — PICASSO, MARI and TSO playbooks.',
...
function expertiseHits(): SearchHit[] {
  return [
    {
      id: 'industry-uk-energy',
      contentType: 'Industry',
      kicker: 'INDUSTRY',
      title: 'UK Energy',
      summary:
        'Helping energy companies thrive in a shifting landscape — utilities, transition, trading and cyber resilience. Named expert Elisabeth Plakinger.',
    ...
    },
    {
      ...
      kicker: 'CAMPAIGN',
      title: 'AI Infused',
      summary: 'Process, data and AI in how we deliver.',
      href: '/ai',
      dateSort: '2026-01-01',
      tag: 'AI',
      sector: 'Banking and Payments',
    ...
    },
    {
      ...
      service: 'Energy',
      region: 'United Kingdom',
      keywords: 'contact enquiry hubspot',
    },
    {
      id: 'page-preferences',
      contentType: 'Page',
      ...
      service: 'Energy',
      region: 'United Kingdom',
      keywords: 'preferences register industry topic region',
    },
    {
      id: 'page-journal-62',
      contentType: 'Perspective',
      ...
      href: '/capco-institute/journal-62',
      dateSort: '2026-01-01',
      tag: 'Journal',
      sector: 'Capital Markets',
      service: 'Capital Markets',
      region: 'Europe',
      keywords: 'journal 62 capco institute html',
    },
    {
      id: 'page-expertise-action',
      contentType: 'Industry',
      kicker: 'PROOF',
      title: 'Expertise in Action',
      href: '/about-us/expertise-in-action',
      dateSort: '2026-01-01',
      tag: 'Energy',
      sector: 'Energy',
      service: 'Energy',
      region: 'Europe',
      keywords: 'case study expertise in action europe',
    },
    {
      id: 'page-events',
      contentType: 'Page',
      kicker: 'EVENTS',
      title: 'Events',
      summary: 'T+1 breakfast, energy trading briefing, payments fraud roundtable.',
      href: '/events',
      dateSort: '2026-10-01',
      tag: 'Events',
      sector: 'Energy',
    ...
    },
    {
      ...
      service: 'Capital Markets',
      region: 'Europe',
      keywords: 'event t+1 elisabeth priya',
    },
  ];
}
