...
import { STORY_INTRO, STORY_LIFECYCLE, STORY_PAINS, STORY_PERSONAS } from '@/lib/capco-story';
    ...
    <section className="pm-story" id={id}>
      <div className="pm-wrap py-16">
        ...
        <p className="pm-story__lede">
          ...
          is the human integration layer, not a profile on this site. Priya finds Elisabeth via
          Perspectives, not a generic industry page.
        </p>
