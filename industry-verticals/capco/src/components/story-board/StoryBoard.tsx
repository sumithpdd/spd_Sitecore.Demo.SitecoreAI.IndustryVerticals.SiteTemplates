...
import { STORY_ACTS, STORY_BEATS } from '@/lib/capco-story';
    ...
    <section className="pm-story" id={id}>
      <div className="pm-wrap py-16">
        ...
        <p className="pm-story__intro">
          Three acts. Live links stay on this site — Elisabeth, the T+1 Perspective, people, Capital
          Markets. External tools (Scrunch, ChatGPT, Mini CMS) stay in the talk track.
        </p>
