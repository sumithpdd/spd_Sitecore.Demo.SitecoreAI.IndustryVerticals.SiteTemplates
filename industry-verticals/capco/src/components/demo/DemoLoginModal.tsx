      ...
      <div className="forma-login-modal__card relative w-full max-w-md rounded-lg bg-white p-8 shadow-2xl md:p-10">
        ...
        {loginStep === 'account' ? (
          <>
            ...
            <button
              type="button"
              className="border-border hover:border-accent bg-background-accent mt-4 flex w-full items-center gap-3 rounded-lg border p-3 text-left transition-colors"
