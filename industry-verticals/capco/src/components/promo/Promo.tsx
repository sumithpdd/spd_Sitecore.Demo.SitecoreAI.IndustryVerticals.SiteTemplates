...
export const PromoContent = (props: PromoProps) => {
  ...
  return (
    <div className="space-y-5">
      ...
      <ContentSdkLink field={props.fields.PromoMoreInfo} className="arrow-btn" />
    </div>
  );
};
...
export const WithQuote = (props: PromoProps): JSX.Element => {
  ...
  return (
    <section
      className={`relative ${sxaStyles} z-10 overflow-hidden pb-15 xl:pb-[4%]`}
      id={id ? id : undefined}
    >
      {withQuote && (
        <div
...
/** Pinsent Careers: image left, copy right. */
export const ImageLeft = (props: PromoProps): JSX.Element => {
  ...
  if (!props.fields) {
    return (
      <section
        className={`pm-careers pm-careers--image-left ${sxaStyles}`}
        id={id ? id : undefined}
      >
        [CAREERS PROMO]
      </section>
  ...
  return (
    <section className={`pm-careers pm-careers--image-left ${sxaStyles}`} id={id ? id : undefined}>
