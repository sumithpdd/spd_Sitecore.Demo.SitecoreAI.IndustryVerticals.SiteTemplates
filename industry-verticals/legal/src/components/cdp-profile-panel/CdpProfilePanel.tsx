                ...
                <div className="space-y-4">
                  <div className="space-y-4 rounded-lg border border-[#e8e8e8] bg-white p-6 shadow-sm">
                    ...
                    <div className="space-y-2 border-t pt-4">
                      ...
                      {isFirstVisit ? (
                        <div className="border-accent/30 bg-background-accent text-foreground-muted rounded-lg border p-3 text-sm">
                          This is your first visit to Pinsent Masons (this browser).
                        </div>
                      ) : (
