...
If the homepage shows orange boxes for components such as Offers, LanguageSwitcher, or Features, the site is usually bound to the wrong rendering host (for example `luxury-retail` instead of `nextjsstarter`).
