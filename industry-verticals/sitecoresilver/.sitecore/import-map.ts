...
import { ProductDetailsSection } from 'src/components/non-sitecore/ProductDetailsSection';
...
import { ProductSpecifications } from 'src/components/non-sitecore/ProductSpecifications';
import { ProductSupportDrivers } from 'src/components/non-sitecore/ProductSupportDrivers';
...
const importMap = [
  ...
  {
    module: '@/lib/sitecoresilver-field-utils',
    exports: [
      { name: 'richTextValue', value: richTextValue },
      { name: 'textValue', value: textValue },
  ...
  {
    module: '@/lib/sitecoresilver-copenhagen-defaults',
    exports: [
      { name: 'RICH_GLASS_DEFAULTS', value: RICH_GLASS_DEFAULTS },
      { name: 'PROMO_CTA_DEFAULTS', value: PROMO_CTA_DEFAULTS },
      { name: 'PROMO_BAND_DEFAULTS', value: PROMO_BAND_DEFAULTS },
      { name: 'INTRO_DEFAULTS', value: INTRO_DEFAULTS },
  ...
  {
    module: 'src/components/non-sitecore/ProductDetailsSection',
    exports: [
      { name: 'ProductDetailsSection', value: ProductDetailsSection },
    ]
  },
  {
    module: 'react-share',
  ...
  {
    module: 'src/components/non-sitecore/ProductSpecifications',
    exports: [
      { name: 'ProductSpecifications', value: ProductSpecifications },
    ]
  },
  {
    module: 'src/components/non-sitecore/ProductSupportDrivers',
    exports: [
      { name: 'ProductSupportDrivers', value: ProductSupportDrivers },
    ]
  },
  {
