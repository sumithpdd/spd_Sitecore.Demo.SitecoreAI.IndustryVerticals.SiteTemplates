...
import * as SitecoreSilverRichText from 'src/components/sitecoresilver/SitecoreSilverRichText';
import * as SitecoreSilverPromoImageCta from 'src/components/sitecoresilver/SitecoreSilverPromoImageCta';
import * as SitecoreSilverPromoFullWidth from 'src/components/sitecoresilver/SitecoreSilverPromoFullWidth';
import * as SitecoreSilverPromoBadgeGrid from 'src/components/sitecoresilver/SitecoreSilverPromoBadgeGrid';
import * as SitecoreSilverPromoBadge from 'src/components/sitecoresilver/SitecoreSilverPromoBadge';
import * as SitecoreSilverIntroBanner from 'src/components/sitecoresilver/SitecoreSilverIntroBanner';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['SitecoreSilverRichText', { ...SitecoreSilverRichText }],
  ['SitecoreSilverPromoImageCta', { ...SitecoreSilverPromoImageCta }],
  ['SitecoreSilverPromoFullWidth', { ...SitecoreSilverPromoFullWidth }],
  ['SitecoreSilverPromoBadgeGrid', { ...SitecoreSilverPromoBadgeGrid }],
  ['SitecoreSilverPromoBadge', { ...SitecoreSilverPromoBadge }],
  ['SitecoreSilverIntroBanner', { ...SitecoreSilverIntroBanner }],
