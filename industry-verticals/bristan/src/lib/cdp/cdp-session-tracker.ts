...
const SESSION_ID_KEY = 'bristan-cdp-session-id';
const SESSION_EVENTS_KEY = 'bristan-cdp-session-events';
const VISIT_COUNT_KEY = 'bristan-cdp-visit-count';
const VISIT_FLAG_KEY = 'bristan-cdp-visit-recorded';
