...
| Home / SilverAttendees / Sumith Damodaran | `/SilverAttendees/Sumith-Damodaran` | Individual attendee profile — **page template** holds profile fields |
...
**Serialized profiles:** Sumith Damodaran and Morten Ljungberg use the page-as-datasource pattern. A legacy `Data/Sumith Damodaran` item remains for reference but is not wired on the profile page rendering.
